<?php 
    ...
    $image= $_GET['image'];
    $name_post= $_GET['name_post'];
    $class_detect= $_GET['class_detect'];
    $avatar= $_GET['avatar'];
    $id_current= $_GET['id_current'];
?>
<div class="item">
            <div class="item1" style="margin-bottom:10px">
                <div class="item1-1">
                    <img class="item1-1-1" style="object-fit:cover" src="<?php echo $avatar ?>" alt="">
                    <div class="item1-1-2">
                        <p class="item1-1-2-1"><?php echo $name_post ?></p>
            ...
            <div class="item2" style="display:flex;padding: 12px 16px 0 16px">
                <div class="item2-1 amn<?php echo $id_current ?>">
                    <p class="item2-1-1"><?php echo $text ?></p>
                </div>
            </div>
            <style>
                .amn<?php echo $id_current ?> {
                    height: <?php
                                    if ($background !== '') {
                                        echo 300;
                                        echo 'px';
